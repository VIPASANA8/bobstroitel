    ...
    @media all{
      ...
      body.v014.poker8-v2-sixmax .table-frame{
        ...
        background:
          ...
          linear-gradient(180deg,#0c0503,#000000 78%,#000000)!important;
      }
      ...
      body.v014.poker8-v2-sixmax .felt{
        ...
        background:
          ...
          linear-gradient(145deg,#06462c,#003b24 58%,#022d1d) padding-box,
          linear-gradient(90deg,#231005 0,#6f3515 16%,#301405 31%,#955524 50%,#301405 68%,#6f3c16 84%,#231005 100%) border-box!important;
        outline:1px solid rgba(74,255,205,.58)!important;
        box-shadow:
          inset 0 0 72px rgba(0,0,0,.42),
          inset 0 0 0 2px rgba(44,255,198,.10),
          0 0 0 2px rgba(0,0,0,.92),
          0 0 12px rgba(28,238,188,.20),
          0 0 26px rgba(28,238,188,.10)!important;
      }

      body.v014.poker8-v2-sixmax .felt::before{
        inset:7px!important;
        border-color:rgba(44,255,205,.58)!important;
      ...
      body.v014.poker8-v2-sixmax .seat-stack{
        ...
        text-shadow:0 0 8px rgba(64,237,167,.16)!important;
      }
      ...
      body.v014.poker8-v2-sixmax .position-chip{
        ...
        border:1px solid rgba(111,143,137,.24)!important;
      }
      ...
      body.v014.poker8-v2-sixmax .seat-card{
        ...
        background:linear-gradient(180deg,rgba(9,10,10,.96),rgba(0,0,0,.99))!important;
      }
      ...
      body.v014.poker8-v2-sixmax .seat[data-visual-seat="0"] .seat-card{
        ...
        border-color:rgba(47,179,255,.82)!important;
        box-shadow:0 0 0 1px rgba(47,179,255,.14),0 0 16px rgba(31,174,255,.20),0 10px 24px rgba(0,0,0,.46)!important;
      }
      ...
      body.v014.poker8-v2-sixmax .seat[data-visual-seat="0"] .player-avatar{
        ...
        border-color:rgba(47,184,255,.90)!important;
        box-shadow:0 0 0 1px rgba(47,184,255,.18),0 0 18px rgba(31,174,255,.30)!important;
      }
      ...
      body.v014.poker8-v2-sixmax .pot-total{
        ...
        border:1px solid rgba(66,226,171,.18)!important;
        border-radius:10px!important;
        background:rgba(4,31,20,.82)!important;
        box-shadow:0 6px 18px rgba(0,0,0,.22),inset 0 0 14px rgba(55,220,162,.025)!important;
      }
      body.v014.poker8-v2-sixmax .pot-total-label{color:#9bc5b5!important;font-size:10px!important;letter-spacing:.10em!important}
      body.v014.poker8-v2-sixmax .pot-total strong{color:#ffffff!important;font-size:20px!important;text-shadow:0 0 9px rgba(72,239,180,.16)!important}
      ...
      body.v014.poker8-v2-sixmax .v028-center-ready-button{
        ...
        border-color:rgba(47,179,255,.72)!important;
        background:linear-gradient(180deg,rgba(5,42,67,.98),rgba(2,21,38,.99))!important;
        box-shadow:0 0 14px rgba(47,179,255,.14),inset 0 0 15px rgba(53,198,255,.04)!important;
      }
      ...
      body.v014.poker8-v2-sixmax.human-turn .sidebar .action-panel{
        ...
        background:linear-gradient(180deg,rgba(0,0,0,.99),rgba(0,0,0,1))!important;
