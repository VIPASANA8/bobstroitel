(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!document.querySelector('script[data-v026-seat-status-layout]')) {
      ...
      v026.src = "/static/v026-seat-status-layout.js?v=referral-tab-icon-1";
    ...
    if (!document.querySelector('script[data-v027-compact-seats-controls]')) {
      ...
      v027.src = "/static/v027-compact-seats-controls.js?v=referral-tab-icon-1";
    ...
    if (!document.querySelector('script[data-v028-ready-phase]')) {
      ...
      readyPhase.src = "/static/v028-ready-phase.js?v=referral-tab-icon-1";
    ...
    if (!document.querySelector('script[data-v032-poker8-v2-sixmax]')) {
      ...
      v032.src = "/static/v032-poker8-v2-mobile-sixmax.js?v=referral-tab-icon-1";
      ...
      v032.addEventListener("load", () => {
        if (!document.querySelector('script[data-v037-poker8-v2-reference-table]')) {
          ...
          finalMobile.src = "/static/v037-poker8-v2-reference-table.js?v=referral-tab-icon-1";
