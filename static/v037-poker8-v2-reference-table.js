(() => {
  ...
  function ensureTurnClarityPatch() {
    ...
    v041.src = "/static/v041-poker8-v2-turn-clarity.js?v=cube-route-1";
  ...
  function ensureDynamicSeatLayout() {
    ...
    v040.src = "/static/v040-poker8-v2-dynamic-seats.js?v=cube-route-1";
  ...
  if (!document.querySelector('script[data-v038-poker8-v2-cinematic-table]')) {
    ...
    v038.src = "/static/v038-poker8-v2-cinematic-table.js?v=cube-route-1";
