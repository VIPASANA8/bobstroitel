...
def test_v038_uses_full_height_arc_and_viewport_edge_controls():
    ...
    assert '/static/component-ui.js?v=mobile-layout-prod-9' in index
    assert '/static/online-table.js?v=mobile-layout-prod-9' in index
    assert '/static/v037-poker8-v2-reference-table.js?v=mobile-layout-prod-9' in component
    assert '/static/v038-poker8-v2-cinematic-table.js?v=mobile-layout-prod-9' in loader
